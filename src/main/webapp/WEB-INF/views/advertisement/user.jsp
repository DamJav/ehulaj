...
<table>
<h1 class="title">Moje ogłoszenia</h1>
<for:forEach items="${listAd}" var="ad">
    ...
    <tr>
        ...
        <td>Miasto: ${ad.city} <br/> Tel: ${ad.phone} </td>
        <c:url value="/user/advertisement/delete" var="deleteURL">
            <c:param name="id" value="${ad.id}"/>
        </c:url>
        <td> <a href="${deleteURL}">Usuń</a></td>
        <c:url value="/user/advertisement/update" var="updateURL">
            <c:param name="id" value="${ad.id}"/>
        </c:url>
